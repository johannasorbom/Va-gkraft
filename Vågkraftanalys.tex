...
Vågkraft är en relativt ny energiteknik med stor potential. Världens totala potentiella vågenergi kan uppskattas till 2 TW, vilket är av ungefär samma ordning som världens totala elanvändning. Men idag används endast en bråkdel av denna energi. Detta beror på barriärer i form av teknik,  ekonomi, planering och licenser samt infrastruktur. I denna uppsats kommer dessa barriärer att tas upp presenteras för att besvara frågan om varför vågkraften inte redan är mer utbredd.  \newpage
